...
public class RejectTests
{
    ...
    public void WhenShipperIsNull_ShouldThrowArgumentNullException()
    {
        ...
        // act
        TestDelegate action = () => shipment.Reject(shipper, offerId);
    ...
    [Test]
    public void WhenRejected_ShouldRejectOffer()
    {
        // arrange
        Shipper shipper = ShipperBuilder.Create().Build();
        Carrier carrier = CarrierBuilder.Create().Build();
        ...
        // act
        shipment.Reject(shipper, offer.OfferId);
    ...
    [Test]
    public void WhenRejected_ShouldShipmentBeActive()
    {
        // arrange
        ...
        // assert
        Assert.That(shipment.IsActive, Is.True); 
    }
}